...
<p>Wenn man gemeinhin über einen Stream spricht ist im damit im Grunde die Datenübertragung von Audio und Video Daten gemeint. Daraus ergibt sich, dass es grundsätzlich folgende Formen des Streaming gibt:</p>
<ol>
 <li><b>Audio</b> (z.B.: Podcasts, Musik, ...)</li>
 <li><b>Video</b> (z.B.: Youtube, Vimeo, ...)</li>
 <li><b>Live A/V</b> (z.B.: Audio/Video Livestream)</li>
</ol>
